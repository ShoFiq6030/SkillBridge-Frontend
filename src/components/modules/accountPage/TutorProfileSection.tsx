...
export function TutorProfileSection({ tutor }: TutorProfileSectionProps) {
      ...
      <CardContent className="space-y-6">
        ...
        <div className="flex gap-2">
          <Button asChild variant="outline">
            <Link href={`/tutors/${tutor.id}`}>View Public Profile</Link>
          </Button>
          <Button asChild>
            <Link href={`/tutors/${tutor.id}/edit`}>Edit Profile</Link>
          </Button>
        </div>
      </CardContent>
    </Card>
